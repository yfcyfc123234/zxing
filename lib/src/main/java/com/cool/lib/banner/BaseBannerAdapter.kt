...
import com.cool.lib.ext.getDefaultImageError
import com.cool.lib.ext.getDefaultImageFallback
import com.cool.lib.ext.getDefaultImagePlaceholder
    ...
    override fun onCreateHolder(parent: ViewGroup?, viewType: Int): BaseBannerHolder {
        ...
        val roundedView = RoundedImageView(context)
            .apply {
                ...
                cornerRadius = parent.context.resources.getDimension(com.chad.library.R.dimen.dp_10)
            }
